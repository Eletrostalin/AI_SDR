            ...
            try:
                ...
                if not existing_company:
                    ...
                    await bot.send_message(
                        chat_id=chat_id,
                        text=f"👋 Здравствуйте, {telegram_user.full_name}!\n"
                             "Я — AI SDR, ваш интеллектуальный сотрудник. \n"
                             "Я возьму на себя лиды, рассылки и первичные коммуникации, чтобы вы могли сосредоточиться на главном. Давайте начнем!"
                    )
