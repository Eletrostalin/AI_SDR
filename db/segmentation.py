...
FILTER_TYPES = {
    ...
    "msp_registry": ["bool", "str"],  # True (есть в реестре) / False (нет)
    "director_name": ["bool", "str"],  # True (должен быть указан) или конкретное ФИО
    "director_position": ["bool", "str"],  # Должность директора - строка
    ...
    "primary_activity": ["bool", "str"],  # Основной вид деятельности - строка
